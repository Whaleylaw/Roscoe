...
- **offer-evaluation**: Analyze offer merits
- **negotiation-strategy**: Develop counter strategy
- **settlement-analysis**: Compare to case value
- **client-communication**: Present offer to client
- **lien-negotiation**: Factor in lien reductions
