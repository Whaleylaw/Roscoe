...
# Use WORKSPACE_DIR first (consistent with agent.py and tools.py), fallback to WORKSPACE_ROOT
# This ensures script executor uses the same workspace path as the rest of the system
WORKSPACE_ROOT = Path(os.environ.get("WORKSPACE_DIR", os.environ.get("WORKSPACE_ROOT", "/mnt/workspace")))
...
def execute_python_script(
    ...
    api_keys_to_pass = [
        ...
        "AIRTABLE_API_KEY",
        "ASSEMBLYAI_API_KEY",
        # KYeCourts credentials for court docket lookups
        "KYECOURTS_USERNAME",
        "KYECOURTS_PASSWORD",
    ]
