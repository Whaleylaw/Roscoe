...
def _create_fallback_model():
    ...
    return _wrap_with_message_normalization(ChatGoogleGenerativeAI(
...
def _create_primary_model():
    ...
    if MODEL_PROVIDER == "anthropic":
        return _wrap_with_message_normalization(ChatAnthropic(
        ...
        return _wrap_with_message_normalization(ChatOpenAI(
            model="gpt-5.2",
            max_retries=3,
            temperature=0,
...
def get_summarization_llm():
    ...
    if _summarization_llm_instance is None:
        _summarization_llm_instance = _wrap_with_message_normalization(ChatAnthropic(
