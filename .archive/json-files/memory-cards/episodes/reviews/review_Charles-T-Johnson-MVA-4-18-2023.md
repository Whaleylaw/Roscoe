# Relationship Review: Charles-T-Johnson-MVA-4-18-2023

**Total Episodes:** 190

**Total Proposed Relationships:** 659
...
- Integra Medical Imaging (radiology)
...
- [ ] Amy Cox — *✓ MATCHES: Amy Cox*
- [ ] Benjamine Groce — *✓ MATCHES: Benjamine Groce*
- [ ] Thomas Rivera — *✓ ADDED to adjusters.json*

### Attorney (12 consolidated)
- [ ] @jchumbley — *IGNORED - email/handle reference*
- [ ] Aaron Gregory Whaley — *✓ MATCHES: Aaron G. Whaley (WHALEY ATTORNEY)*
- [ ] Amy Romine — *✓ ADDED to attorneys.json*
- [ ] Charles T. Johnson — *✓ MATCHES: Charles T Johnson (CLIENT, not Attorney)*
...
- [ ] Lowe — *✓ CONSOLIDATED → Robert Lowe*
- [ ] Mary S. Johnson — *✓ MATCHES: Mary S. Johnson (attorney at Dilbeck & Myers)*
- [ ] Mary [last name] — *IGNORED - incomplete name*
- [ ] Sarena M. Tuttle — *✓ MATCHES: Sarena Tuttle (WHALEY STAFF → should be CaseManager)*
- [ ] Sarena Whaley — *✓ MATCHES: Sarena Tuttle (WHALEY STAFF → should be CaseManager)*
...
- [ ] State Farm Insurance Company (Adjuster: Benjamine Groce) — *✓ MATCHES: State Farm Insurance Company*

### Client (3 consolidated)
- [ ] Charles T. Johnson — *✓ MATCHES: Charles T Johnson*
- [ ] Client — *IGNORED - generic reference*
- [ ] Justin — *✓ MATCHES: Justin Chumbley (WHALEY STAFF → should be CaseManager, not Client)*

### Court (11 consolidated)
- [ ] Charles Johnson v. Robert Lowe (24-CI-002475) — *IGNORED - case caption*
- [ ] Court Net — *IGNORED - software reference*
- [ ] District Court — *✓ MATCHES: Christian County District Court*
- [ ] Jeff Cir 24-CI-002475 — *✓ CONSOLIDATED → Jefferson County Circuit Court*
- [ ] Jefferson 24-CI-002475 — *✓ MATCHES: Jefferson County Circuit Court, Division VII*
- [ ] Jefferson Circuit (Kentucky Court of Justice) — *✓ MATCHES: Kentucky Court Of Justice (court system org)*
- [ ] Jefferson Circuit Court (24-CI-002475) — *✓ MATCHES: Jefferson County Circuit Court*
- [ ] Jefferson Circuit Court (Jeff Cir) — *✓ CONSOLIDATED → Jefferson County Circuit Court*
- [ ] Jefferson Circuit Court (Kentucky) — *✓ CONSOLIDATED → Jefferson County Circuit Court*
- [ ] Jefferson County (24-CI-002475) — *✓ MATCHES: Jefferson County Circuit Court, Division VII*
- [ ] Jefferson County (Docket 24-CI-002475) — *✓ CONSOLIDATED → Jefferson County Circuit Court*

### Defendant (3 consolidated)
- [ ] Charles T. Johnson — *✓ MATCHES: Charles T Johnson (CLIENT, not Defendant)*
- [ ] Lowe — *✓ CONSOLIDATED → Robert Lowe*
- [ ] Robert Lowe — *✓ ADDED to defendants.json*
...
- [ ] Arenas Logistics, LLC — *✓ ADDED to organizations.json*
...
- [ ] OMB Medical Records Requests (Louisville office) — *IGNORED - document processing service*
- [ ] OMBMRR@Louisvilleky.gov — *IGNORED - email address*

### PIPClaim (2 consolidated)
- [ ] Auto Owners Insurance PIP claim — *✓ MATCHES: Auto Owners Insurance*
