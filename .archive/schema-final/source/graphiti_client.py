...
Pure Pydantic entity type definitions and relationship mappings for the Roscoe platform.

This file defines:
- 65 entity types for legal case management
- 110+ relationship patterns (EDGE_TYPE_MAP)
- Complete schema for FalkorDB knowledge graph

Database: FalkorDB (Redis-compatible graph database)
Pattern: Direct Cypher queries (no ORM library)
