...
**Source:** https://www.claude.com/blog/building-skills-for-claude-code  
...
If you were to ask [Claude Code](https://www.claude.com/product/claude-code) to help you query your company's data warehouse, it might suggest standard SQL patterns and best practices. The suggestions are sound, but they're not *your* patterns—Claude doesn't know your table structures, business terminology, or which metrics require specific filters to be accurate.
...
[Skills](https://www.claude.com/blog/skills) change this by providing modular packages that teach Claude your specific workflows. Install them in Claude Code or enable them in [Claude.ai](http://claude.ai/) and Claude will automatically reference them when relevant tasks come up during conversations. Think of Skills as specialized onboarding documents that train AI to work exactly like your team does.
...
The [Skills marketplace shares even more examples to inspire you.](https://skillsmp.com/) Explore community-built skills that extend what Claude can do—from automated testing and data visualization to code review and domain name brainstorming.
