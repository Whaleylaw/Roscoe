...
# Add workspace_paralegal to path for imports
workspace_path = Path("/Volumes/X10 Pro/Roscoe/workspace_paralegal")
...
def compute_sol_status(overview: Dict, rules: Dict) -> Dict:
...
def compute_workflow_state(project_name: str) -> WorkflowState:
    ...
    # Compute SOL
    sol_status = compute_sol_status(case_data.overview, rules)
