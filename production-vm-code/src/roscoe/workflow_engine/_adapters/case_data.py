...
Vendored from Roscoe_runtime/workflow_engine/_adapters/case_data.py
...
Usage:
    from roscoe.workflow_engine._adapters.case_data import CaseData
...
def get_workspace_path() -> Path:
    ...
    Priority:
    1. WORKSPACE_DIR (production VM)
    2. WORKSPACE_ROOT (Docker container)
    3. ROSCOE_ROOT (legacy)
    4. Common fallback paths
    """
    # Production VM and Docker environments
    ...
    common_paths = [
        ...
        Path("/workspace_paralegal"),  # Alternative mount
    ...
    # Try relative to script (for testing)
